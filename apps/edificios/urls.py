...
# para generar pdf de detalle factura (factura que se entregara a los propietarios)
    # url(r'^listar/unidades/(?P<id_propiedad>[A-Za-z0-9-_]+)/(?P<pk>[A-Za-z0-9-_]+)/detallefactura/(?P<factura>[A-Za-z0-9-_]+)/pdf$', PDFTemplateView.as_view(template_name='Pagos/apdf.html',
                                           # filename='my_pdf.pdf'), name='pdf'),#listara los administradores
    url(r'^listar/unidades/(?P<id_propiedad>[A-Za-z0-9-_]+)/(?P<pk>[A-Za-z0-9-_]+)/detallefactura/(?P<factura>[A-Za-z0-9-_]+)/pdf$',\
                                 apdf, name='facturapdf'),
url(r'^apdf/$',to_pdf,name= "to_pdf"),
